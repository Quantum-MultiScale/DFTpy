...
# some function used in free energy density functional

import numpy as np

from dftpy.math_utils import PowerInt

__all__ = ['get_reduce_t', 'ftk', 'ftk_dt', 'ftk_dt2', 'ftk_dt3', 'fth',
           'fth_dt', 'fth_dt2',
...
FTK_U = np.array(
    [-2.5, -2.141088549, 0.2210798602, 0.0007916274395, -0.004351943569,
     0.004188256879, -0.002144912720, 0.0005590314373, -0.00005824689694, 0.0])

FTK_D = np.array(
    [1.0, -4.112335167, 1.995732255, 14.83844536, -178.4789624, 992.5850212,
     -3126.965212, 5296.225924, -3742.224547, 0.0])

FTT0 = 0.543010717965

FTH_U = np.array(
    [3.0, -0.7996705242, 0.2604164189, -0.1108908431, 0.06875811936,
