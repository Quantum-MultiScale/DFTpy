...
If you want to construct your own LPP, follow this `tutorial <tutorials/jupyter/lpps.ipynb>`_. The formalism behind this new class of pseudopotentials is described in the paper *Pseudononlocal Pseudopotentials for Orbital-Free DFT*.
